...
public class Monitoring extends CustomCommand {

    public Monitoring() { super("monitoring","links"); }

    @Override
    public void execute(CommandSender sender, String label, String[] args) {
        Player player = (Player) sender;
        if (args.length == 0) sendLinksSetting(player, "monitoring");
        else sendHelpMessage(player, message("monitoringCommandUsage"), "/monitoring");
    }
}
